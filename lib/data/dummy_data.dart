...
import 'package:ecommerce_application_fullsatck_v2/features/shop/models/product_attribute_model.dart';
...
class AppDummyModel {
  ...
  static final List<BrandModel> brands = [
    BrandModel(
      id: '1',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123054/Brands%20Images/u8xhbijndqyjkbnvl4r6.png",
      name: 'Nike',
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '2',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123055/Brands%20Images/lvq7toapb33c7ruzmpn3.jpg",
      name: 'Adidas',
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '3',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123056/Brands%20Images/xamtytdytmfor7h9aqs5.jpg",
      name: 'Apple',
      productsCount: 8,
      isFeatured: true,
    ),
    BrandModel(
      id: '4',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123056/Brands%20Images/s8eldd9iqbhguvvjueok.png",
      name: 'Bata',
      productsCount: 4,
      isFeatured: true,
    ),
    BrandModel(
      id: '5',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123057/Brands%20Images/r3wcztfglk5p7sj3jy5r.png",
      name: 'Bloody',
      productsCount: 9,
      isFeatured: false,
    ),
    BrandModel(
      id: '6',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123058/Brands%20Images/y9veivcwejjxaerh0jzp.jpg",
      name: 'Breakout',
      productsCount: 7,
      isFeatured: true,
    ),
    BrandModel(
      id: '7',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123060/Brands%20Images/tqzskckapotpvoapzy0g.png",
      name: 'Dari Mooch',
      productsCount: 4,
      isFeatured: true,
    ),
    BrandModel(
      id: '8',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123061/Brands%20Images/gxg3agymud543v7k3drd.jpg",
      name: 'Interwood',
      productsCount: 9,
      isFeatured: false,
    ),
    BrandModel(
      id: '9',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123062/Brands%20Images/neqth2xyv6hs9vmzycta.jpg",
      name: 'HP',
      productsCount: 4,
      isFeatured: false,
    ),
    BrandModel(
      id: '10',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123063/Brands%20Images/dhpkkqwfj0dhniid6n8o.png",
      name: 'J.',
      productsCount: 8,
      isFeatured: true,
    ),
    BrandModel(
      id: '11',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123064/Brands%20Images/jcxdbxwcuuxnsw4on551.png",
      name: 'NDURE',
      productsCount: 4,
      isFeatured: true,
    ),
    BrandModel(
      id: '12',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123065/Brands%20Images/hou5nyxy73cnaj1dlran.jpg",
      name: 'NorthStar',
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '13',
      image:
          "https://res.cloudinary.com/dsrnxif9n/image/upload/v1758123066/Brands%20Images/xyqjups7jtjks9z3wvki.png",
      name: 'Polo',
      productsCount: 2,
      isFeatured: true,
    ),
  ...
  static final List<ProductModel> products = [
    ...
    ProductModel(
        ...
        price: 30,
        isFeatured: true,
        thumbnail: AppImages.productImage2,
        description:
    ...
    ProductModel(
        ...
        price: 700,
        isFeatured: false,
        thumbnail: AppImages.productImage3,
        description:
    ...
    ProductModel(
        ...
        price: 350,
        isFeatured: true,
        thumbnail: AppImages.productImage4a,
        description:
        ...
        brand: brands[2],
        images: [AppImages.productImage4b, AppImages.productImage4c, AppImages.productImage4d, AppImages.productImage4e],
        sku: 'ABR4568',
        categoryId: '19',
        productAttributes: [
        ...
        productVariations: [
          ProductVariationModel(
              ...
              stock: 5,
              price: 250,
              image: AppImages.productImage4b,
    ...
    ProductModel(
        ...
        price: 60,
        isFeatured: false,
        thumbnail: AppImages.productImage5,
        description:
    ...
    ProductModel(
      ...
      stock: 50,
      price: 55.99,
      thumbnail: AppImages.productImage8,
      description:
    ...
    ProductModel(
      ...
      salePrice: 7.99,
      price: 8.99,
      thumbnail: AppImages.productImage9,
      description:
    ...
    ProductModel(
        ...
        price: 39.99,
        stock: 23,
        thumbnail: AppImages.productImage13,
        description:
    ...
    ProductModel(
        ...
        stock: 54,
        salePrice: 47.99,
        thumbnail: AppImages.productImage15,
        description:
    ...
    ProductModel(
      ...
      price: 79.99,
      salePrice: 71.99,
      thumbnail: AppImages.productImage16a,
      images: [AppImages.productImage16b],
      stock: 153,
      description:
    ...
    ProductModel(
      ...
      stock: 19,
      brand: brands[5],
      thumbnail: AppImages.productImage17,
      description:
    ...
    ProductModel(
      ...
      price: 59.99,
      salePrice: 49.99,
      thumbnail: AppImages.productImage19a,
      images: [AppImages.productImage19b],
      stock: 12,
      brand: brands[10],
      categoryId: '10',
      description:
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage20,
      price: 44.99,
      salePrice: 39.99,
      stock: 43,
      brand: brands[3],
    ...
    ProductModel(
      ...
      price: 29.99,
      salePrice: 26.99,
      thumbnail: AppImages.productImage25,
      stock: 23,
      brand: brands[5],
      description:
    ...
    ProductModel(
      ...
      price: 49.99,
      salePrice: 44.99,
      thumbnail: AppImages.productImage26,
      stock: 23,
      brand: brands[7],
      description:
    ...
    ProductModel(
        ...
        price: 12.99,
        thumbnail: AppImages.productImage27,
        brand: brands[6],
        description:
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage29,
      stock: 3,
      price: 9.99,
      salePrice: 7.56,
      description:
    ...
    ProductModel(
        ...
        thumbnail: AppImages.productImage30,
        stock: 3,
        price: 29.99,
        salePrice: 27.99,
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage31,
      price: 69.99,
      salePrice: 52.99,
      stock: 2,
      description:
    ...
    ProductModel(
        ...
        productVariations: [
          ProductVariationModel(
              ...
              image: AppImages.productImage32,
              stock: 3,
              price: 499.99,
              salePrice: 475.99,
    ...
    ProductModel(
        ...
        price: 849,
        thumbnail: AppImages.productImage33a,
        images: [AppImages.productImage33b, AppImages.productImage33c, AppImages.productImage33d],
        description:
        ...
        productVariations: [
          ProductVariationModel(
              ...
              image: AppImages.productImage33b,
              stock: 3,
              price: 849,
              salePrice: 799,
          ...
          ProductVariationModel(
              ...
              image: AppImages.productImage33c,
              stock: 3,
              price: 849,
              salePrice: 799,
          ...
          ProductVariationModel(
              ...
              image: AppImages.productImage33d,
              stock: 3,
              price: 849,
              salePrice: 799,
          ...
          ProductVariationModel(
              id: '4',
              attributeValues: {'Storage': '64GB', 'Color': 'Black'},
              image: AppImages.productImage33a,
              stock: 3,
              price: 849,
              salePrice: 799,
    ...
    ProductModel(
        ...
        salePrice: 1133.99,
        stock: 34,
        thumbnail: AppImages.productImage38a,
        images: [AppImages.productImage38b, AppImages.productImage38c],
        productType: 'ProductType.variable',
        categoryId: '18',
        sku: "LAPTOP-HP",
        brand: brands[8],
        ...
        productVariations: [
          ProductVariationModel(
              ...
              price: 899.99,
              salePrice: 869.99,
              image: AppImages.productImage38b),
          ProductVariationModel(
              id: '2',
              attributeValues: {'Storage': '1TB'},
              stock: 23,
              ...
              price: 999.99,
              salePrice: 969.99,
              image: AppImages.productImage38c)
        ]),
    ...
    ProductModel(
        ...
        thumbnail: AppImages.productImage40,
        productType: 'ProductType.single',
        stock: 2,
        price: 399.99,
        salePrice: 375.99,
    ...
    ProductModel(
        ...
        thumbnail: AppImages.productImage43,
        stock: 21,
        price: 479.99,
        salePrice: 452.99,
        productType: 'ProductType.single',
    ...
    ProductModel(
        ...
        thumbnail: AppImages.productImage44,
        stock: 21,
        price: 49.99,
        productType: 'ProductType.single',
        categoryId: '17',
    ...
    ProductModel(
        ...
        thumbnail: AppImages.productImage45a,
        images: [AppImages.productImage45b],
        stock: 21,
        price: 29.99,
        salePrice: 28.99,
        productType: 'ProductType.variable',
        ...
        productVariations: [
          ProductVariationModel(
              ...
              price: 29.99,
              salePrice: 28.99,
              image: AppImages.productImage45a),
          ProductVariationModel(
              id: '2',
              ...
              price: 29.99,
              salePrice: 28.99,
              image: AppImages.productImage45b),
        ]),
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage48,
      stock: 21,
      price: 59.99,
      salePrice: 52.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
        ...
        thumbnail: AppImages.productImage49a,
        images: [AppImages.productImage49b],
        stock: 21,
        price: 89.99,
        salePrice: 84.99,
        productType: 'ProductType.variable',
        ...
        productVariations: [
          ProductVariationModel(
              ...
              price: 89.99,
              salePrice: 84.99,
              image: AppImages.productImage49a),
          ProductVariationModel(
              id: '2',
              attributeValues: {'Color': 'Red'},
              stock: 23,
              ...
              price: 89.99,
              salePrice: 84.99,
              image: AppImages.productImage49b),
        ]),
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage50,
      stock: 21,
      price: 499.99,
      salePrice: 456.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage53,
      stock: 21,
      price: 399.99,
      salePrice: 376.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage55,
      stock: 2,
      price: 299.99,
      salePrice: 275.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage56,
      stock: 2,
      price: 180,
      salePrice: 177,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage57,
      stock: 2,
      price: 49,
      productType: 'ProductType.single',
      categoryId: '8',
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage58,
      stock: 2,
      price: 799.99,
      salePrice: 743.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage59,
      stock: 2,
      price: 1299,
      salePrice: 743.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage61,
      stock: 2,
      price: 129,
      salePrice: 127,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage62,
      stock: 2,
      price: 259,
      productType: 'ProductType.single',
      categoryId: '21',
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage63,
      stock: 2,
      price: 249,
      salePrice: 212,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage66,
      stock: 2,
      price: 15,
      productType: 'ProductType.single',
      categoryId: '8',
    ...
    ProductModel(
        ...
        thumbnail: AppImages.productImage67a,
        images: [AppImages.productImage67b, AppImages.productImage67c],
        stock: 2,
        price: 8,
        productType: 'ProductType.variable',
        categoryId: '7',
        ...
        productVariations: [
          ProductVariationModel(
              ...
              sku: 'SKU-BREAKOUT',
              price: 8,
              image: AppImages.productImage67a),
          ProductVariationModel(
              id: '2',
              ...
              sku: 'SKU-BREAKOUT',
              price: 8,
              image: AppImages.productImage67b),
          ProductVariationModel(
              id: '3',
              ...
              sku: 'SKU-BREAKOUT',
              price: 8,
              image: AppImages.productImage67c),
          ProductVariationModel(
              id: '4',
    ...
    ProductModel(
      ...
      thumbnail: AppImages.productImage68,
      stock: 2,
      price: 27,
      productType: 'ProductType.single',
      categoryId: '9',
