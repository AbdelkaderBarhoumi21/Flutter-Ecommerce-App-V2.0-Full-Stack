...
class AllProductController extends GetxController {
 ...
 //fetch product using dynamic query
  ...
  void sortProducts(String sortOption) {
    /*
      print("Apple".compareTo("Banana")); // -1 → "Apple" vient avant "Banana"
      print("Orange".compareTo("Banana")); // 1 → "Orange" vient après "Banana"
      print("Mango".compareTo("Mango"));   // 0 → égal 
    */
